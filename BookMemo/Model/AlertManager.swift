...
final class AlertManager {
    ...
    func showAlert() -> UIAlertController{
        ...
        case .saveSucceed:
            ...
            alertController.addAction(UIAlertAction(title: "book一覧へ", style: .default, handler: {(UIAlertAction) in
        ...
        case .removeWarning:
            ...
            return alertController
        case .selectSearchMethod:
            let alertController = UIAlertController(title: "メモの新規作成", message: "本の情報を取得します。", preferredStyle: .actionSheet)
